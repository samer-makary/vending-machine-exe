...
public class VendingMachine {
	...
	private JTextField textFieldSlotProductQuantity;
	...
	private void initialize() {
		...
		panelDisplay.setBorder(new TitledBorder(null, "Machine Display", TitledBorder.LEADING, TitledBorder.TOP, new Font("Tahoma", Font.PLAIN, 20), UIManager.getColor("TitledBorder.titleColor")));
		...
		panelProducts.setBorder(new TitledBorder(null, "Products", TitledBorder.LEADING, TitledBorder.TOP, new Font("Tahoma", Font.PLAIN, 20), UIManager.getColor("TitledBorder.titleColor")));
		consumerPanel.add(panelProducts);
		panelProducts.setLayout(new GridLayout(2, 5, 1, 1));
		
		JButton btnProduct1 = new JButton("X");
		...
		JButton btnProduct2 = new JButton("X");
		...
		JButton btnProduct3 = new JButton("X");
		...
		panelCashOut.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Cash Out", TitledBorder.LEADING, TitledBorder.TOP, new Font("Tahoma", Font.PLAIN, 20), new Color(0, 0, 0)));
		...
		panelSlots.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Slots", TitledBorder.LEADING, TitledBorder.TOP, new Font("Tahoma", Font.PLAIN, 20), new Color(0, 0, 0)));
		...
		panelProductInfo.setBorder(new TitledBorder(null, "Slot Product Info", TitledBorder.LEADING, TitledBorder.TOP, new Font("Tahoma", Font.PLAIN, 20), null));
		panelProductInfo.setBounds(15, 239, 509, 122);
		maintenancePanel.add(panelProductInfo);
		panelProductInfo.setLayout(new GridLayout(2, 4, 5, 5));
		...
		panelProductInfo.add(lblQuantity);
		...
		textFieldSlotProductQuantity = new JTextField();
		textFieldSlotProductQuantity.setFont(new Font("Tahoma", Font.PLAIN, 20));
		textFieldSlotProductQuantity.setHorizontalAlignment(SwingConstants.CENTER);
		panelProductInfo.add(textFieldSlotProductQuantity);
		textFieldSlotProductQuantity.setColumns(10);
		...
		panelCashReload.setBorder(new TitledBorder(null, "Cash Reload", TitledBorder.LEADING, TitledBorder.TOP, new Font("Tahoma", Font.PLAIN, 20), null));
